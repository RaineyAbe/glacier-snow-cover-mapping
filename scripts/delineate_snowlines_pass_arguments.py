...
parser = argparse.ArgumentParser(description="delineate_snowlines with arguments passed by the user",
...
parser.add_argument('-im_classified_path', default=None, type=str, help='Path in directory to classified images')
...
parser.add_argument('-snowlines_path', default=None, type=str, help='Where to save output snowlines in directory')
parser.add_argument('-figures_out_path', default=None, type=str, help='Where to save output figures in directory')
args = parser.parse_args()

# -----Set user arguments as variables
site_name = args.site_name
base_path = args.base_path
im_classified_path = args.im_classified_path
AOI_path = args.AOI_path
AOI_fn = args.AOI_fn
snowlines_path = args.snowlines_path
figures_out_path = args.figures_out_path

print('Delineating snowlines for:')
print(site_name)
print('--------------------')
print(' ')
